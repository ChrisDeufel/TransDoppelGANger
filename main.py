...
dataset = "FCC_MBA"
checkpoint_dir = 'runs/{0}/1/checkpoint'.format(dataset)
if not os.path.exists(checkpoint_dir):
    os.makedirs(checkpoint_dir)
time_logging_file = 'runs/{0}/1/time.log'.format(dataset)
config_logging_file = 'runs/{0}/1/config.log'.format(dataset)
# SET UP LOGGING
