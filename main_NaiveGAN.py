...
import os
from trainer_NaiveGAN import NAIVEGAN, add_handler_trainer, add_config_handler_trainer
...
trainer = NAIVEGAN(real_train_dl, device=device, checkpoint_dir=checkpoint_dir, isWasserstein=isWasserstein)
epochs = 400
